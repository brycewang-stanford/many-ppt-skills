...
<!-- BEGIN:COUNTS -->
**227 skills tracked**, **39 of them read by hand** · **318,567 combined stars** · 83 HTML-native · 79 native PPTX · 25 both · data refreshed **2026-09-26**
<!-- END:COUNTS -->
...
|---|---:|---|---|---|
| **[PPT Master](https://github.com/hugohe3/ppt-master)**<br><sub>hugohe3</sub> | 56,452 | PPTX | MIT | Documents or topics into genuinely native, editable PowerPoint decks. |
| **[Slidev](https://github.com/slidevjs/slidev)**†<br><sub>slidevjs</sub> | 48,845 | Framework | MIT | A developer-focused framework for building presentation slides with Markdown and Vue. |
| **[Frontend Slides](https://github.com/zarazhangrui/frontend-slides)**<br><sub>Zara Zhang</sub> | 29,845 | HTML | MIT | Beautiful slides on the web using a coding agent's frontend skills. |
| **[Guizang PPT Skill](https://github.com/op7418/guizang-ppt-skill)**<br><sub>op7418 (歸藏)</sub> | 26,963 | HTML | ⚠️ AGPL-3.0 | Editorial-magazine and Swiss-International HTML decks, with design locked down by constraint. |
| **[Huashu Design](https://github.com/alchaincyf/huashu-design)**<br><sub>花生 (alchaincyf)</sub> | 24,460 | Both | MIT | HTML-native design skill — prototypes, decks, motion and design critique, not just slides. |
| **[Quarkdown](https://github.com/iamgio/quarkdown)**†<br><sub>iamgio</sub> | 16,215 | Framework | GPL-3.0 | A Markdown-based framework that produces papers, presentations, websites, and books from one source. |
| **[Banana Slides](https://github.com/Anionex/banana-slides)**†<br><sub>Anionex</sub> | 15,663 | PPTX | ⚠️ AGPL-3.0 | AI-native PPT generator that accepts templates, text prompts, or outlines and exports editable PPTX files. |
| **[Visual Explainer](https://github.com/nicobailon/visual-explainer)**<br><sub>nicobailon</sub> | 9,923 | HTML | MIT | Rich HTML pages or decks for diagrams, diff reviews, plan audits, data tables and project recaps. |
| **[HTML Anything](https://github.com/nexu-io/html-anything)**†<br><sub>nexu-io</sub> | 8,951 | Suite | Apache-2.0 | An agentic HTML editor with 75 skills across 9 surface types including decks, posters, and prototypes. |
| **[Dashi PPT Skill](https://github.com/chuspeeism/dashi-ppt-skill)**†<br><sub>chuspeeism</sub> | 8,813 | Both | ⚠️ AGPL-3.0 | Generates browser-editable presentations from multiple visual themes, exportable to HTML, PDF, and PPTX. |
| **[HTML PPT Studio](https://github.com/lewislulu/html-ppt-skill)**<br><sub>lewislulu</sub> | 8,515 | HTML | MIT | 24 themes, 31 layouts and 20+ animations for professional HTML presentations. |
| **[open-slide](https://github.com/1weiho/open-slide)**<br><sub>1weiho</sub> | 7,654 | Framework | MIT | A slide framework built for agents — React components on a fixed 1920x1080 canvas. |
| **[Codex PPT Skill](https://github.com/ningzimu/codex-ppt-skill)**†<br><sub>ningzimu</sub> | 6,201 | Image | MIT | Uses GPT-Image-2 to generate image-based PowerPoint slides within Codex and compatible agents. |
| **[Anthropic PPTX (official)](https://github.com/anthropics/skills/tree/main/skills/pptx)**<br><sub>Anthropic</sub> | 178,487* | PPTX | See repo | The official baseline — create, read, edit and combine PowerPoint files. |
| **[Baoyu Skills](https://github.com/JimLiu/baoyu-skills/tree/main/skills/baoyu-slide-deck)**†<br><sub>JimLiu (宝玉)</sub> | 26,163* | Suite | MIT | A 22-skill personal pack whose baoyu-slide-deck turns an article or outline into a deck. |

### Tier A — Production-ready (100–5k stars)

| Skill | ⭐ | Route | License | What it is |
|---|---:|---|---|---|
| **[Beautiful HTML Templates](https://github.com/zarazhangrui/beautiful-html-templates)**<br><sub>Zara Zhang</sub> | 4,656 | Templates | MIT | 34 HTML slide templates with index.json metadata so any agent can pick the right one. |
| **[Codex Claude Academic Skills](https://github.com/zLanqing/codex-claude-academic-skills)**†<br><sub>zLanqing</sub> | 4,307 | Suite | MIT | Three-skill suite for researchers covering paper reading, PPT/Word generation, writing help, and scientific charts. |
| **[Baoyu Design](https://github.com/JimLiu/baoyu-design)**†<br><sub>JimLiu</sub> | 4,196 | HTML | MIT | Runs Claude's Design system prompt locally to produce UI mockups, decks, and wireframes as self-contained HTML. |
| **[NanoBanana PPT Skills](https://github.com/op7418/NanoBanana-PPT-Skills)**†<br><sub>op7418</sub> | 3,271 | Image | Unspecified | AI skill that generates high-quality PPT slide images and videos with transitions and interactive playback. |
| **[Gorden PPT Skill](https://github.com/GordenSun/GordenPPTSkill)**†<br><sub>GordenSun</sub> | 3,154 | PPTX | NOASSERTION | Builds PPTX files from 17 Chinese templates by applying text edits defined in a JSON file, layouts intact. |
| **[Image to Editable PPT Skill](https://github.com/ningzimu/image-to-editable-ppt-skill)**†<br><sub>ningzimu</sub> | 2,698 | PPTX | MIT | Converts slide images, PDFs, and image-based PPTX files into editable PowerPoint decks. |
| **[Oh My PPT](https://github.com/arcsin1/oh-my-ppt)**†<br><sub>arcsin1</sub> | 2,072 | HTML | Apache-2.0 | Takes a text description and generates clean HTML slides locally, with no internet connection required. |
| **[Gorden Super PPT Skills](https://github.com/GordenSun/GordenSuperPPTSkills)**†<br><sub>GordenSun</sub> | 2,016 | PPTX | Unspecified | Generates high-quality PPT images with GPT and converts them into fully editable PPTX files. |
| **[CyberPPT](https://github.com/crazyykhllc-bit/CyberPPT)**†<br><sub>crazyykhllc-bit</sub> | 1,732 | PPTX | MIT | Codex skill for generating dense, editable consulting-style PowerPoint decks with SCR narrative and quality checks. |
| **[Ian Handdrawn PPT](https://github.com/helloianneo/ian-handdrawn-ppt)**†<br><sub>helloianneo</sub> | 1,444 | Image | MIT | Generates hand-drawn-style Chinese technical PPT slide images in PNG, with 21:9 covers and 16:9 body slides. |
| **[GPT Image2 PPT Skills](https://github.com/JuneYaooo/gpt-image2-ppt-skills)**†<br><sub>JuneYaooo</sub> | 1,308 | Image | Apache-2.0 | Clones a PPTX layout using gpt-image-2 so you can swap in your own content; includes 10 built-in styles. |
| **[PPT Image First](https://github.com/NyxTides/ppt-image-first)**†<br><sub>NyxTides</sub> | 1,218 | Image | Apache-2.0 | An image-first PPT generation skill for Codex, Claude Code, and Opencode CLI agents. |
| **[Academic PPTX](https://github.com/Gabberflast/academic-pptx-skill)**<br><sub>Gabberflast</sub> | 1,055 | PPTX | MIT | Conference talks, seminar slides, thesis defenses and grant briefings. |
| **[Humanize PPT](https://github.com/LearnPrompt/humanize-ppt)**†<br><sub>LearnPrompt</sub> | 956 | HTML | NOASSERTION | An AST-based outline director that structures human-centered AI presentation workflows. |
| **[Codex Slides](https://github.com/nexu-io/codex-slides)** | 919 | Framework | MIT | AI slide studio for Codex: image-native decks, parallel render, and PDF/PPTX export. |
| **[PPT Agent Skills](https://github.com/sunbigfly/ppt-agent-skills)**†<br><sub>sunbigfly</sub> | 901 | HTML | NOASSERTION | A code-driven framework for generating presentations the same way you build software. |
| **[Claude Office Skills](https://github.com/tfriedel/claude-office-skills)**<br><sub>tfriedel</sub> | 833 | PPTX | Unspecified | PPTX, DOCX, XLSX and PDF workflows with automation support. |
| **[Claude Skills](https://github.com/staruhub/ClaudeSkills)**†<br><sub>staruhub</sub> | 722 | Suite | MIT | A curated set of 13 Claude Code agent skills covering decks, research, PRDs, articles, and audits. |
| **[Power Design](https://github.com/ItsssssJack/power-design)**†<br><sub>ItsssssJack</sub> | 698 | HTML | NOASSERTION | A Claude skill that applies brand identity and 20 design principles to produce slides that look hand-crafted. |
| **[PPT Agent Workflow San](https://github.com/mucsbr/ppt-agent-workflow-san)**<br><sub>mucsbr</sub> | 642 | HTML | Unspecified | Progressive, interactive deck generation. |
| **[Frontend Slides Editable](https://github.com/archlizheng/frontend-slides-editable)**<br><sub>archlizheng</sub> | 524 | Both | MIT | Editable HTML decks with drag-resize, reordering, local save and PPTX conversion. |
| **[RW Consulting PPT](https://github.com/Pikapika260214/rw-consulting-ppt)**†<br><sub>Pikapika260214</sub> | 458 | PPTX | MIT | A Codex skill for building editable consulting-style PowerPoint decks. |
| **[Paper2Anything](https://github.com/QuZhan51496/paper2anything)**†<br><sub>QuZhan51496</sub> | 457 | Suite | Apache-2.0 | Converts an academic paper PDF into slides, a poster, a webpage, a Xiaohongshu post, or a WeChat article. |
| **[Reveal.js Skill](https://github.com/ryanbbrown/revealjs-skill)**†<br><sub>ryanbbrown</sub> | 410 | HTML | MIT | A coding agent skill for building reveal.js HTML presentations. |
| **[Visual Style PPT Skill](https://github.com/irenerachel/visual-style-ppt-skill)**†<br><sub>irenerachel</sub> | 388 | PPTX | Unspecified | A skill that runs a visual-style PPT generation workflow. |
| **[DOM to PPTX](https://github.com/atharva9167j/dom-to-pptx)**†<br><sub>atharva9167j</sub> | 366 | PPTX | MIT | Client-side library that converts any HTML element into a pixel-accurate, fully editable PowerPoint slide. |
| **[Beamer Skill](https://github.com/Noi1r/beamer-skill)**†<br><sub>Noi1r</sub> | 360 | HTML | MIT | Manages the full lifecycle of academic Beamer LaTeX slides: create, compile, review, quality score, and polish. |
| **[Marp Slides](https://github.com/robonuggets/marp-slides)**†<br><sub>robonuggets</sub> | 311 | HTML | Unspecified | MARP presentation skill with 22 example decks, SVG charts, and dark/light themes for Claude Code. |
| **[Beamer Academic](https://github.com/Faust-Donf/beamer-academic)**†<br><sub>Faust-Donf</sub> | 301 | HTML | MIT | Generates high-quality academic thesis defense Beamer slides from a paper with a single command. |
| **[Mck PPT Design System](https://github.com/likaku/Mck-ppt-design-skill)**<br><sub>likaku</sub> | 289 | PPTX | Apache-2.0 | Consulting-firm-style design system: 70 layout patterns, flat design, python-pptx. |
| **[Thesis Defense PPTX Skill](https://github.com/zouchenzhen/thesis-defense-pptx-skill)**†<br><sub>zouchenzhen</sub> | 265 | PPTX | Apache-2.0 | Generates an editable thesis-defense PPTX from a PDF or LaTeX source while preserving a chosen template. |
| **[PPT SVG Generator](https://github.com/vigorX777/ppt-svg-generator)**<br><sub>vigorX777</sub> | 259 | PPTX | MIT | Markdown to PPT or PDF via SVG, with preset styles. |
| **[Planners PPT Hell](https://github.com/thePlannerIvan/planners-ppt-hell)**†<br><sub>thePlannerIvan</sub> | 233 | PPTX | ⚠️ AGPL-3.0 | A PPT generation skill aimed at planners. |
| **[Apple Bento Grid](https://github.com/hubeiqiao/apple-bento-grid)**†<br><sub>hubeiqiao</sub> | 232 | HTML | MIT | Generates Apple-inspired bento grid presentation cards as HTML output. |
| **[Hands on Deck](https://github.com/EveryInc/hands-on-deck)**†<br><sub>EveryInc</sub> | 218 | PPTX | MIT | CLI tool that lets AI agents inspect, edit, create, and verify PPTX files through atomic JSON patches. |
| **[Codex PPT Skill](https://github.com/Ronnie2025/codex-ppt-skill)**†<br><sub>Ronnie2025</sub> | 215 | Image | MIT | Codex workflow for generating, composing, and SVG-decomposing Chinese business presentation slides. |
| **[Skywork Skills](https://github.com/SkyworkAI/Skywork-Skills)**†<br><sub>SkyworkAI</sub> | 202 | Suite | MIT | Agent skill suite covering AI PPT, documents, Excel, images, deep research, and music for any compatible agent. |
...
| **[Claude Design Skill](https://github.com/jiji262/claude-design-skill)**†<br><sub>jiji262</sub> | 199 | HTML | MIT | Adapts Claude.ai's internal Design prompt locally to produce HTML decks, landing pages, prototypes, and posters. |
| **[Slide Image to Editable PPTX](https://github.com/w1163222589-coder/slide-image-to-editable-pptx)**†<br><sub>w1163222589-coder</sub> | 196 | PPTX | MIT | Converts slide screenshots into editable PowerPoint decks. |
| **[Presentation Skills](https://github.com/Sven-LI-sankyuu/presentation-skills)**†<br><sub>Sven-LI-sankyuu</sub> | 174 | Both | Unspecified | Codex CLI skill collection for editable PPT diagram collaboration and web demo video synthesis workflows. |
...
| **[Servasyy Skills](https://github.com/huangserva/servasyy_skills)**†<br><sub>huangserva</sub> | 167 | Suite | Unspecified | A suite of AI skills covering writing, illustration, PPT, podcast, video, and comic generation. |
| **[PPT Agent Skill](https://github.com/Akxan/ppt-agent-skill)**<br><sub>Akxan</sub> | 154 | HTML | MIT | 26 styles and 18 chart types benchmarked against Linear, Anthropic, Stripe, Apple and NYT. |
| **[Slide Deck Generator](https://github.com/code-on-sunday/slide-deck-generator)**†<br><sub>code-on-sunday</sub> | 150 | HTML | MIT | Creates browser-based slide decks using React, Vite, and Framer Motion from a coding agent prompt. |
| **[Future Slide](https://github.com/bytonylee/future-slide)**†<br><sub>bytonylee</sub> | 148 | Suite | Apache-2.0 | Ten slide skills split across plan, prompt and render, for both HTML and GPT-image decks. |
| **[Make Slide](https://github.com/Kuneosu/make-slide)**†<br><sub>Kuneosu</sub> | 129 | HTML | MIT | Generates standalone HTML slide decks from a prompt. |
| **[Image to PPTX Skill](https://github.com/knight6669/knight-imagetopptx-skill)**†<br><sub>knight6669</sub> | 126 | PPTX | MIT | Converts slide images into editable PowerPoint files using semantic understanding. |
| **[PowerPoint Skill](https://github.com/Noi1r/powerpoint-skill)**†<br><sub>Noi1r</sub> | 122 | PPTX | MIT | Creates PPTX presentations with native math, LaTeX formulas, and Graphviz/Mermaid/TikZ diagrams. |
| **[Presentation Skills](https://github.com/pamelafox/presentation-skills)**†<br><sub>pamelafox</sub> | 122 | HTML | MIT | AI agent skills for processing and generating presentations, aimed at teachers and speakers. |
...
| **[Literature Report PPT Builder](https://github.com/fangyuanopus/literature-report-ppt-builder)**†<br><sub>fangyuanopus</sub> | 110 | PPTX | MIT | Generates academic literature-report PowerPoint decks from research content. |
| **[CN Academic Spark](https://github.com/wycmochi/cn-academic-spark)**†<br><sub>wycmochi</sub> | 104 | PPTX | MIT | Generates editable academic PPTX from uploaded papers for thesis, lab, and course presentations. |
| **[AI Skills (Cross-Platform)](https://github.com/sanjay3290/ai-skills/tree/main/skills/google-slides)**†<br><sub>sanjay3290</sub> | 426* | Suite | Apache-2.0 | 24 cross-platform agent skills for Claude Code, Cursor and Codex, including Google Slides. |

### Tier B — Specialized & emerging (<100 stars)

| Skill | ⭐ | Route | License | What it is |
|---|---:|---|---|---|
| **[Starry Slides](https://github.com/StarryKit/starry-slides)**<br><sub>StarryKit</sub> | 95 | Framework | MIT | Slide editor that gives your agent fully editable decks with HTML as the source file. |
...
| **[Knowledge Cat PPT Skill](https://github.com/gnipbao/knowledge-cat-ppt-skill)**†<br><sub>gnipbao</sub> | 87 | Both | MIT | Creates and QA-checks PPT, HTML, and image-first decks using a story-first approach. |
| **[Lieflat HTML Design](https://github.com/larashero3-dotcom/lieflat-html-design)**†<br><sub>larashero3-dotcom</sub> | 87 | HTML | MIT | Produces HTML slide decks and Xiaohongshu cards via agent-ready design skills. |
| **[HTML Slides](https://github.com/bluedusk/html-slides)**<br><sub>bluedusk</sub> | 84 | HTML | MIT | HTML slides with speaker notes, plus a companion presentation app. |
...
| **[Space Multi Design PPT](https://github.com/SpaceZephyr/space-multi-design-ppt)**†<br><sub>SpaceZephyr</sub> | 78 | PPTX | Unspecified | Generates branded slide decks following a design system via Codex. |
| **[SJTU PPT Template Skill](https://github.com/ACTAshui/sjtu-ppt-template-skill)**†<br><sub>ACTAshui</sub> | 77 | PPTX | Unspecified | Creates editable PowerPoint decks styled after Shanghai Jiao Tong University templates. |
| **[Deck Factory](https://github.com/gongnyang/deck-factory)**†<br><sub>gongnyang</sub> | 77 | HTML | MIT | Turns a one-line prompt into a dark-editorial HTML presentation deck. |
| **[HTML to Editable PPTX](https://github.com/Hasasasa/html-to-editable-pptx)**†<br><sub>Hasasasa</sub> | 71 | PPTX | MIT | Converts HTML slide decks to PPTX with native text boxes rather than screenshot images. |
| **[Presentation Skill](https://github.com/siril9/presentation-skill)**†<br><sub>siril9</sub> | 68 | PPTX | MIT | Source-first Codex skill that generates editable PPTX decks with style routing and QA. |
| **[Awesome PPT Skills](https://github.com/stevenjinlong/awesome-ppt-skills)**†<br><sub>stevenjinlong</sub> | 66 | Image | Unspecified | Converts a text prompt into full-slide PPT decks rendered as images via gpt-image-2. |
| **[Editable Image to PPT Skill](https://github.com/soulmujoco/EditableImage2PPTSkill)**†<br><sub>soulmujoco</sub> | 65 | PPTX | MIT | Converts PPT slide images into editable PowerPoint decks. |
| **[Huawei Style PPT Skill](https://github.com/zuiho-kai/huawei-style-ppt-skill)**<br><sub>zuiho-kai</sub> | 64 | HTML | Custom | High-information-density decks in the Huawei corporate idiom. |
| **[Presentation](https://github.com/appautomaton/presentation)**†<br><sub>appautomaton</sub> | 59 | Both | Unspecified | Turns a business question into a consulting-grade deck via four composable skills for PDF and PPTX. |
| **[KingDee PPT Skill](https://github.com/WayneZhon/KingDee-PPT-Skill)**<br><sub>WayneZhon</sub> | 57 | HTML | MIT | KingDee corporate style decks. |
| **[next-slide](https://github.com/codesstar/next-slide)**<br><sub>codesstar</sub> | 54 | HTML | MIT | 26+ styles, zero dependencies, bilingual. |
| **[Slide Creator](https://github.com/kaisersong/slide-creator)**<br><sub>kaisersong</sub> | 52 | Both | Unspecified | AI planning, style discovery and PPTX export. |
| **[ImageGen PPTX Pipeline](https://github.com/eddyzzl/imagegen-pptx-pipeline)**†<br><sub>eddyzzl</sub> | 48 | PPTX | MIT | Generates editable PPTX decks using image generation and converts slide images to PowerPoint. |
| **[Codex Image to Editable PPT](https://github.com/wiltonesten-web/codeximage-to-editable-ppt-v1)**†<br><sub>wiltonesten-web</sub> | 48 | PPTX | MIT | Rebuilds image-based PPT slides into editable PowerPoint decks via Codex. |
| **[Slide Wright](https://github.com/arifszn/slide-wright)**†<br><sub>arifszn</sub> | 48 | HTML | MIT | Generates unique reveal.js HTML slide decks with a distinct design for each prompt. |
...
| **[Scholar PPT CN](https://github.com/deathcats4/scholar-ppt-cn)**†<br><sub>deathcats4</sub> | 45 | PPTX | MIT | Converts academic papers to editable PowerPoint with planning tables and mockup layouts via Codex. |
| **[30x McKinsey Research Deck](https://github.com/norahe0304-art/30x-mckinsey-research-deck)**†<br><sub>norahe0304-art</sub> | 45 | PPTX | MIT | Turns a research prompt into a McKinsey-style market research deck with adversarially verified data using a multi-agent pipeline. |
| **[Paper PPT Skill](https://github.com/xiao634zhang/paper-ppt-skill)**†<br><sub>xiao634zhang</sub> | 44 | PPTX | Unspecified | Generates clean academic slides from a PDF paper, supporting templates, speaker notes, and images. |
| **[Slide Writer](https://github.com/FeeiCN/slide-writer)**<br><sub>FeeiCN</sub> | 43 | HTML | MIT | Enterprise HTML decks from ideas, outlines, documents or speech drafts. |
...
| **[Slides AI Plugin](https://github.com/proyecto26/slides-ai-plugin)**†<br><sub>proyecto26</sub> | 40 | Both | MIT | Turns a single prompt into an animated HTML or editable PowerPoint presentation. |
...
| **[HTML to PPT PDF](https://github.com/wangzan101/html-to-ppt-pdf)**†<br><sub>wangzan101</sub> | 37 | Both | MIT | Converts HTML slide decks to PDF and image-based PPTX for offline use. |
| **[Beautiful Hackathon Slides](https://github.com/Esther2524/beautiful-hackathon-slides)**†<br><sub>Esther2524</sub> | 36 | HTML | MIT | Creates bold-design HTML pitch decks suited for hackathon presentations. |
| **[PPTX Template Skills](https://github.com/CxyZyr/PPTX-Template-Skills)**†<br><sub>CxyZyr</sub> | 36 | PPTX | MIT | Parses a PowerPoint template into a machine-readable contract, then fills it with new content to produce a completed deck. |
| **[Skills Slides](https://github.com/nghiahsgs/skills-slides)**<br><sub>nghiahsgs</sub> | 35 | HTML | Unspecified | 50 aesthetics x 20 palettes x 10 fonts x 5 layouts x 30+ effects. |
| **[PPTX from Layouts](https://github.com/tristan-mcinnis/pptx-from-layouts-skill)**<br><sub>tristan-mcinnis</sub> | 35 | PPTX | MIT | Generate decks from markdown strictly through a template's slide master layouts. |
...
| **[Image PPT King](https://github.com/TateZhouSiu/image-ppt-king)**†<br><sub>TateZhouSiu</sub> | 33 | PPTX | MIT | Converts slide screenshots and generated images into editable PPTX with OCR evidence and QA. |
...
| **[Presentation Skill](https://github.com/OrangeViolin/presentation-skill)**†<br><sub>OrangeViolin</sub> | 28 | HTML | Unspecified | Takes a topic and generates a playable HTML slideshow in one of 62 brand design styles. |
| **[Econ Empirical Paper PPT Skill](https://github.com/1793065778/econ-empirical-paper-ppt-skill)**†<br><sub>1793065778</sub> | 27 | PPTX | Unspecified | Converts empirical economics papers into structured presentation blueprints ready for PowerPoint. |
...
| **[Slide Design Skill](https://github.com/SlideSpeak/slide-design-skill)**†<br><sub>SlideSpeak</sub> | 25 | HTML | MIT | Takes a deck description and renders 1920x1080 HTML slides with a derived style, real charts, tables, and images. |
| **[Beamer Skill](https://github.com/JaxonJP/beamer-skill)**†<br><sub>JaxonJP</sub> | 24 | HTML | MIT | Full-lifecycle skill for academic Beamer LaTeX presentations: compile, review, QA, and TikZ audit. |
| **[Jingge Sense Deck](https://github.com/jxshow/Jingge-PPT-sense-deck-skill)**†<br><sub>jxshow</sub> | 24 | HTML | Unspecified | HTML deck skill focused on a consistent visual sense across slides. |
| **[Keynote Slides Skill](https://github.com/dbmcco/keynote-slides-skill)**†<br><sub>dbmcco</sub> | 23 | HTML | Unspecified | Generates HTML-based presentation slides in a Keynote style. |
...
| **[GZR NSFC PPT Skill](https://github.com/admithuman/gzr-nsfc-ppt-skill)**†<br><sub>admithuman</sub> | 21 | PPTX | MIT | Generates professional academic defense slides in the style of NSFC grant presentations. |
| **[Create HTML Deck](https://github.com/awesome-skills/create-html-deck)**†<br><sub>awesome-skills</sub> | 20 | HTML | MIT | Builds and verifies browser-native HTML presentations for display on laptops and projectors. |
...
| **[MBB Decks](https://github.com/floflo11/mbb-decks)**†<br><sub>floflo11</sub> | 19 | PPTX | MIT | Produces MBB-style consulting .pptx decks with action-title slides, MECE bullets, and company logos as bullet markers. |
...
| **[Competition PPT Template Skill](https://github.com/che626/competition-ppt-template-first-skill)**†<br><sub>che626</sub> | 17 | PPTX | MIT | Generates editable PPTX competition and defense presentations with real evidence using a template-first approach. |
| **[Econ Slides Skill](https://github.com/hanlulong/econ-slides-skill)**<br><sub>hanlulong</sub> | 17 | Framework | MIT | Turns an economics paper into a Beamer seminar talk, with a timed speaker script. |
| **[Four-Up PPT Generator](https://github.com/woniuniuniu/four-up-ppt-generator)**†<br><sub>woniuniuniu</sub> | 16 | PPTX | ⚠️ AGPL-3.0 | Generates four-slide-per-page PPTX layouts, based on the guizang-ppt-skill. |
| **[Japanese Corporate PPTX Skill](https://github.com/gonta223/japanese-corporate-pptx-skill)**†<br><sub>gonta223</sub> | 16 | PPTX | MIT | Generates corporate-style PPTX presentations in Japanese. |
...
| **[Prada Slides](https://github.com/prodigeproject/pradaslides)**†<br><sub>prodigeproject</sub> | 15 | Both | MIT | Generates PPTX, HTML slides, and PDFs, and handles deck planning for a given audience. |
...
| **[Competition PPT Skill](https://github.com/2750527986liu-maker/competition-ppt-skill)**†<br><sub>2750527986liu-maker</sub> | 15 | PPTX | Unspecified | Generates pitch-deck slides for the China International College Student Innovation Competition using python-pptx and PIL. |
...
| **[Paper Figure PPTX Skill](https://github.com/fengting124/paper-figure-pptx-skill)**†<br><sub>fengting124</sub> | 14 | PPTX | MIT | Reconstructs figures from academic papers into editable, LibreOffice-validated PPTX slides. |
...
| **[OpenCode PPT Studio](https://github.com/Honghurumeng/oc_sdk_ppt)**†<br><sub>Honghurumeng</sub> | 14 | Both | Unspecified | Web app that drafts an outline, refines it in a second session, then builds HTML and PPTX. |
...
| **[McKinsey HTML Design Skill](https://github.com/likaku/mck-html-design-skill)**†<br><sub>likaku</sub> | 13 | HTML | Apache-2.0 | Generates McKinsey-style HTML presentations using Python, with 68 built-in layouts and no dependencies. |
...
| **[USTC PPT Template](https://github.com/zsc58/ustc-ppt-template)**†<br><sub>zsc58</sub> | 13 | Templates | NOASSERTION | Provides a 15-slide blue academic PPT template for USTC with navigation links and a LaTeX pipeline. |
...
| **[HTML to PPTX Skill](https://github.com/artifact-kit/html-to-pptx-skill)**†<br><sub>artifact-kit</sub> | 12 | PPTX | Unspecified | Converts HTML pages into downloadable, editable PowerPoint decks. |
...
| **[Guizang PPT Skill](https://github.com/alingowangxr/guizang-ppt-skill)**†<br><sub>alingowangxr</sub> | 11 | HTML | MIT | Generates web-based presentations, slide illustrations, and social media covers, with Traditional and Simplified Chinese support. |
| **[High Quality Slides](https://github.com/andyqiu847-ai/high-quality-slides)**†<br><sub>andyqiu847-ai</sub> | 11 | HTML | MIT | A research-first, narrative-driven 5-phase Claude Code skill that generates polished HTML presentations. |
...
| **[Presentation Chef](https://github.com/sacredvoid/presentation-chef)**†<br><sub>sacredvoid</sub> | 10 | HTML | MIT | Converts any content into an Apple Keynote-style self-contained HTML presentation with cinematic animations. |
| **[PPT Expert Team](https://github.com/ThunderOne18/ppt-expert-team)**†<br><sub>ThunderOne18</sub> | 10 | Both | NOASSERTION | An eight-step workflow skill that turns articles or scripts into editable HTML, image, or PPTX slides across six styles. |
| **[Paper to LaTeX PPT](https://github.com/moyoo0/paper-to-latex-ppt)**†<br><sub>moyoo0</sub> | 10 | HTML | MIT | Takes an academic paper as input and outputs a slide deck with speaker notes for group meeting presentations. |
| **[Modern PPT](https://github.com/lainshao/modern-ppt)**†<br><sub>lainshao</sub> | 10 | HTML | ⚠️ AGPL-3.0 | Produces single-file HTML presentations with 12 layouts, 3 themes, and interactive charts, compatible with major AI coding agents. |
...
| **[Notrat PPT Studio](https://github.com/NestMold/notrat-ppt-studio-skill)**†<br><sub>NestMold</sub> | 10 | Both | MIT | Creates, edits, and reviews PowerPoint files with image, native-editable, and hybrid output modes plus animations. |
...
| **[Hand-Drawn PPT Skill](https://github.com/danny0926/ppt-skills)**†<br><sub>danny0926</sub> | 9 | Both | Unspecified | Generates text-to-PPTX slides in a hand-drawn rough.js style with visual-first layouts and dual editable layers. |
...
| **[Presentation Forge](https://github.com/thmsgo18/presentation-forge)**†<br><sub>thmsgo18</sub> | 9 | HTML | MIT | Builds self-contained HTML slide decks and imports brand themes from PowerPoint files, images, or descriptions. |
...
| **[PPT Skills](https://github.com/CacinieP/ppt-skills)**†<br><sub>CacinieP</sub> | 7 | PPTX | MIT | Generates themed, CJK-aware, editable PPTX files via PptxGenJS. |
| **[Paper to Scholar Slides](https://github.com/ficooooo/Paper2ScholarSlides)**†<br><sub>ficooooo</sub> | 7 | PPTX | MIT | Converts a literature review draft and paper materials into a structured academic PPTX with citations and figures. |
...
| **[SlideSage](https://github.com/vedraut/slidesage)**†<br><sub>vedraut</sub> | 6 | PPTX | MIT | Generates static .pptx decks from content using storytelling and instructional design principles. |
...
| **[PowerPoint Skill](https://github.com/Shimonimposed141/powerpoint-skill)**†<br><sub>Shimonimposed141</sub> | 5 | PPTX | MIT | Converts academic papers into PowerPoint presentations with native math rendering, diagrams, and multi-stage analysis. |
...
| **[Frontend Slides](https://github.com/dreamid27/frontend-slides)**†<br><sub>dreamid27</sub> | 5 | HTML | MIT | Creates animation-rich HTML presentations from scratch or converts PowerPoint files, with 88 layout presets and 34 templates. |
...
| **[Marp Slides Studio](https://github.com/unsolublesugar/marp-slides-studio)**<br><sub>unsolublesugar</sub> | 1 | Templates | MIT | 50 Marp themes with a gallery, contrast checker and four agent skills for deck work. |
...
| Skill | ⭐ | Route | License | What it is |
|---|---:|---|---|---|
| **[awesome-html-slide-skills](https://github.com/ToseaAI/awesome-html-slide-skills)**†<br><sub>ToseaAI</sub> | 164 | List | Custom | Curated list of HTML slide skills and template libraries. A primary lead source for this registry. |
| **[Awesome-PPT-Design-Skills](https://github.com/software-ai-life/Awesome-PPT-Design-Skills)**†<br><sub>software-ai-life</sub> | 113 | List | Unspecified | Agent-agnostic PPT design skills for high-end editable presentation styles. |
...
|---|---:|---|:-:|---|
| **[PPT Master](https://github.com/hugohe3/ppt-master)** | 56,452 | PPTX | ✅ | Entrance / emphasis / exit / motion-path animations and slide transitions written straight into the file by `pptx_animations.py`; speaker notes can also be rendered to narration audio. |
| **[Notrat PPT Studio](https://github.com/NestMold/notrat-ppt-studio-skill)** | 10 | Both | · | Claims animation across all three output modes — image, natively editable, and hybrid. |
...
| Skill | ⭐ | Route | Basis | What the motion actually is |
|---|---:|---|:-:|---|
| **[Slidev](https://github.com/slidevjs/slidev)** | 48,845 | Framework | ✅ | Click animations (step-by-step reveals), slide transitions and motion effects, all built into the framework. |
| **[Frontend Slides](https://github.com/zarazhangrui/frontend-slides)** | 29,845 | HTML | ✅ | "Animation-rich" zero-dependency single-file HTML; the motion ships with the 12 presets and 34 templates. |
| **[Guizang PPT Skill](https://github.com/op7418/guizang-ppt-skill)** | 26,963 | HTML | ✅ | Motion One entrance animations (bundled locally with a CDN fallback), plus WebGL motion that degrades to a static frame on low-power devices. |
| **[Visual Explainer](https://github.com/nicobailon/visual-explainer)** | 9,923 | HTML | ✅ | The restrained one: entrance and hover motion only where it clarifies hierarchy, `prefers-reduced-motion` respected, continuous glow / pulse / breathing banned outright. |
| **[HTML Anything](https://github.com/nexu-io/html-anything)** | 8,951 | Suite | ✅ | Staggered reveals specified to the millisecond: title at 0s, kicker at 200ms, a 1.2s stroke-dashoffset line draw from 400ms, then data labels every 100ms. |
| **[Dashi PPT Skill](https://github.com/chuspeeism/dashi-ppt-skill)** | 8,813 | Both | ✅ | Element entrances use each component's own built-in effect; the slide-transition style is switchable from the preview control panel. |
| **[HTML PPT Studio](https://github.com/lewislulu/html-ppt-skill)** | 8,515 | HTML | ✅ | 47 animations — 27 CSS plus 20 canvas effects. The deepest motion library of any single skill here. |
| **[Frontend Slides Editable](https://github.com/archlizheng/frontend-slides-editable)** | 524 | Both | ✅ | CSS-only by design — no React, no Motion library. Argues one well-orchestrated staggered load beats scattered micro-interactions. |
...
| **[Slide Deck Generator](https://github.com/code-on-sunday/slide-deck-generator)** | 150 | HTML | · | React + Vite + Framer Motion — the one that hands you a real animation library instead of hand-written CSS. |
| **[HTML Slides](https://github.com/bluedusk/html-slides)** | 84 | HTML | ✅ | "Animation-rich" single-file HTML — same phrasing and lineage as frontend-slides. |
...
| **[KingDee PPT Skill](https://github.com/WayneZhon/KingDee-PPT-Skill)** | 57 | HTML | ✅ | Two tiers: Intersection Observer fades for the ordinary case, GSAP ScrollTrigger for Apple-style scroll narratives. |
| **[next-slide](https://github.com/codesstar/next-slide)** | 54 | HTML | ✅ | "Animation-rich" zero-dependency single file, bilingual out of the box. |
| **[Slide Creator](https://github.com/kaisersong/slide-creator)** | 52 | Both | ✅ | Animation is governed like colour and type — it must come from the chosen style file and nowhere else. |
| **[Slide Writer](https://github.com/FeeiCN/slide-writer)** | 43 | HTML | ✅ | Reveal animations are part of the design system: even a newly built component has to reuse the existing ones. |
| **[Slides AI Plugin](https://github.com/proyecto26/slides-ai-plugin)** | 40 | Both | · | One prompt out to either an animated HTML deck or an editable PowerPoint. |
| **[Skills Slides](https://github.com/nghiahsgs/skills-slides)** | 35 | HTML | ✅ | One `.html` with full animations, responsive sizing and keyboard navigation; 30+ effects feed the combinatorial style engine. |
...
| **[Presentation Chef](https://github.com/sacredvoid/presentation-chef)** | 10 | HTML | · | Aims at Keynote-style "cinematic" animation inside one self-contained file. |
| **[Frontend Slides](https://github.com/dreamid27/frontend-slides)** | 5 | HTML | · | A frontend-slides derivative: animation-rich HTML with 88 layout presets and 34 templates. |
...
| Skill | ⭐ | Route | Basis | What the motion actually is |
|---|---:|---|:-:|---|
| **[Huashu Design](https://github.com/alchaincyf/huashu-design)** | 24,460 | Both | ✅ | The closest thing here to a real motion engine: a Stage + Sprite time-slice model behind `useTime` / `useSprite` / `interpolate` / `Easing`, exporting MP4 / GIF, 60fps interpolation and a scored soundtrack in one command. |
| **[NanoBanana PPT Skills](https://github.com/op7418/NanoBanana-PPT-Skills)** | 3,271 | Image | · | Generates slide images and video with transitions and interactive playback — an image pipeline, not a code one. |
| **[Presentation Skills](https://github.com/Sven-LI-sankyuu/presentation-skills)** | 174 | Both | · | A Codex CLI pack whose second half is an end-to-end web-demo video synthesis workflow. |
| **[Servasyy Skills](https://github.com/huangserva/servasyy_skills)** | 167 | Suite | · | A general AI suite bundling a video-generation skill alongside the deck one — that video is not slide motion. |
...
<!-- BEGIN:GALLERY -->
**Jump to:** [PPT Master](#gallery-ppt-master) · [Frontend Slides](#gallery-frontend-slides) · [Guizang PPT Skill](#gallery-guizang-ppt-skill) · [Huashu Design](#gallery-huashu-design) · [HTML PPT Studio](#gallery-html-ppt-skill) · [open-slide](#gallery-open-slide) · [Beautiful HTML Templates](#gallery-beautiful-html-templates) · [Codex Slides](#gallery-codex-slides) · [PPT Agent Workflow San](#gallery-ppt-agent-workflow-san) · [Frontend Slides Editable](#gallery-frontend-slides-editable) · [Mck PPT Design System](#gallery-mck-ppt-design-skill) · [PPT SVG Generator](#gallery-ppt-svg-generator) · [PPT Agent Skill](#gallery-ppt-agent-skill) · [HTML Slides](#gallery-html-slides-bluedusk) · [KingDee PPT Skill](#gallery-kingdee-ppt-skill) · [next-slide](#gallery-next-slide) · [Slide Creator](#gallery-slide-creator) · [Slide Writer](#gallery-slide-writer) · [Skills Slides](#gallery-skills-slides) · [PPTX from Layouts](#gallery-pptx-from-layouts) · [PowerPoint Fancy Design](#gallery-powerpoint-fancy-design) · [Excalidraw Slides Generator](#gallery-excalidraw-slides-skills) · [Econ Slides Skill](#gallery-econ-slides-skill) · [OpenCode PPT Studio](#gallery-oc-sdk-ppt) · [KR Brand Decks](#gallery-kr-brand-decks) · [CUHK Slides Template (HTML)](#gallery-cuhk-slides-template-html) · [3D HTML Slide Skill](#gallery-3d-html-slide-skill) · [Image to Editable PPT Skill (zhoujie97)](#gallery-image-to-editable-ppt-skill-zhoujie97) · [TaoHtml](#gallery-taohtml) · [TikTok Slideshow Command Center](#gallery-vyral-tiktok-slideshow-skill) · [PPTWork](#gallery-pptwork) · [Inspiration Deck Workshop](#gallery-inspiration-deck-workshop) · [University PPT Skill](#gallery-university-ppt-skill) · [Claude PPT Skills](#gallery-claude-ppt-skills) · [Course HTML Slides Builder](#gallery-course-html-slides-skill) · [Google Slides Deck Skill](#gallery-google-slides-skill) · [PPTX Deck Creation Kit](#gallery-agent-pptify-kit) · [PPT Deck Builder Skill](#gallery-ppt-deck-builder-skill) · [Marp Slides Studio](#gallery-marp-slides-studio) · [Paper Deck Reveal](#gallery-paper-deck-reveal) · [GHB PPT Skill](#gallery-ghb-ppt-skill) · [HTML Presentation Skill](#gallery-html-presentation-skill) · [Slide Deck Skill](#gallery-slide-deck-skill)

<a id="gallery-ppt-master"></a>

#### [PPT Master](https://github.com/hugohe3/ppt-master) · 56,452 ⭐ · PPTX
...
#### [Frontend Slides](https://github.com/zarazhangrui/frontend-slides) · 29,845 ⭐ · HTML
...
#### [Guizang PPT Skill](https://github.com/op7418/guizang-ppt-skill) · 26,963 ⭐ · HTML
...
#### [Huashu Design](https://github.com/alchaincyf/huashu-design) · 24,460 ⭐ · Both
...
#### [HTML PPT Studio](https://github.com/lewislulu/html-ppt-skill) · 8,515 ⭐ · HTML
...
#### [open-slide](https://github.com/1weiho/open-slide) · 7,654 ⭐ · Framework
...
#### [Beautiful HTML Templates](https://github.com/zarazhangrui/beautiful-html-templates) · 4,656 ⭐ · Templates
...
#### [Codex Slides](https://github.com/nexu-io/codex-slides) · 919 ⭐ · Framework
...
#### [PPT Agent Workflow San](https://github.com/mucsbr/ppt-agent-workflow-san) · 642 ⭐ · HTML
...
#### [Frontend Slides Editable](https://github.com/archlizheng/frontend-slides-editable) · 524 ⭐ · Both
...
#### [Mck PPT Design System](https://github.com/likaku/Mck-ppt-design-skill) · 289 ⭐ · PPTX
...
#### [PPT SVG Generator](https://github.com/vigorX777/ppt-svg-generator) · 259 ⭐ · PPTX
...
#### [PPT Agent Skill](https://github.com/Akxan/ppt-agent-skill) · 154 ⭐ · HTML
...
#### [HTML Slides](https://github.com/bluedusk/html-slides) · 84 ⭐ · HTML
...
#### [KingDee PPT Skill](https://github.com/WayneZhon/KingDee-PPT-Skill) · 57 ⭐ · HTML
...
#### [next-slide](https://github.com/codesstar/next-slide) · 54 ⭐ · HTML
...
#### [Slide Creator](https://github.com/kaisersong/slide-creator) · 52 ⭐ · Both
...
#### [Slide Writer](https://github.com/FeeiCN/slide-writer) · 43 ⭐ · HTML
...
#### [Skills Slides](https://github.com/nghiahsgs/skills-slides) · 35 ⭐ · HTML
...
#### [PPTX from Layouts](https://github.com/tristan-mcinnis/pptx-from-layouts-skill) · 35 ⭐ · PPTX
...
#### [Econ Slides Skill](https://github.com/hanlulong/econ-slides-skill) · 17 ⭐ · Framework
...
#### [OpenCode PPT Studio](https://github.com/Honghurumeng/oc_sdk_ppt) · 14 ⭐ · Both
...
#### [Marp Slides Studio](https://github.com/unsolublesugar/marp-slides-studio) · 1 ⭐ · Templates
...
<sub>No imagery in the repositories of: Slidev, Quarkdown, Banana Slides, Visual Explainer, HTML Anything, Dashi PPT Skill, Codex PPT Skill, Codex Claude Academic Skills, Baoyu Design, NanoBanana PPT Skills, Gorden PPT Skill, Image to Editable PPT Skill, Oh My PPT, Gorden Super PPT Skills, CyberPPT, Ian Handdrawn PPT, GPT Image2 PPT Skills, PPT Image First, Academic PPTX, Humanize PPT, PPT Agent Skills, Claude Office Skills, Claude Skills, Power Design, RW Consulting PPT, Paper2Anything, Reveal.js Skill, Visual Style PPT Skill, DOM to PPTX, Beamer Skill, Marp Slides, Beamer Academic, Thesis Defense PPTX Skill, Planners PPT Hell, Apple Bento Grid, Hands on Deck, Codex PPT Skill, Skywork Skills, PPT Image2 Editable Rebuild, Claude Design Skill, Slide Image to Editable PPTX, Presentation Skills, Magic Slide, Servasyy Skills, Slide Deck Generator, Future Slide, Make Slide, Image to PPTX Skill, PowerPoint Skill, Presentation Skills, HTML PPT Designer, Literature Report PPT Builder, CN Academic Spark, Starry Slides, AI Paper to Slide Skill, Knowledge Cat PPT Skill, Lieflat HTML Design, Visual Cognition Slides, PPT Report Skills, Space Multi Design PPT, SJTU PPT Template Skill, Deck Factory, HTML to Editable PPTX, Presentation Skill, Awesome PPT Skills, Editable Image to PPT Skill, Huawei Style PPT Skill, Presentation, ImageGen PPTX Pipeline, Codex Image to Editable PPT, Slide Wright, Baoyu Xuanyi Skills, Scholar PPT CN, 30x McKinsey Research Deck, Paper PPT Skill, Jiarui SVG Skills, Slides AI Plugin, Slidev Skills, Claude Code Codex Slide, PPT Skill, HTML to PPT PDF, Beautiful Hackathon Slides, PPTX Template Skills, BL Captain PPT Skill, Image PPT King, Narrative Engine, PPT Design DNA, Presentation Skill, Econ Empirical Paper PPT Skill, PPT Creator Skills, Slide Design Skill, Beamer Skill, Jingge Sense Deck, Keynote Slides Skill, Claude HTML Slide Builder, PPT Agent, AI Draw Skill, GZR NSFC PPT Skill, Create HTML Deck, HTML to PPTX, Neon Slides, MBB Decks, Interactive Slides, Competition PPT Template Skill, Four-Up PPT Generator, Japanese Corporate PPTX Skill, KAI Presentation, Prada Slides, Keynot, Competition PPT Skill, NanoBanana PPT Skills, PPT Image Share Builder, CyberBin PPT Skill, Paper Figure PPTX Skill, PPT Skill, NanoBanana PPT Skills, McKinsey HTML Design Skill, Fudan University PPT Skill, USTC PPT Template, HalfAI Gufa PPT, Better PPT HTML Deck, HTML to PPTX Skill, TalkTrack, AWS HTML Slides, Editable Leadership PPTX, Guizang PPT Skill, High Quality Slides, SlideStage Pack, Deckset Claude Skill, IML PPTX, SlideSmith, Presentation Chef, PPT Expert Team, Paper to LaTeX PPT, Modern PPT, Aham PPT, Notrat PPT Studio, Bento PPT Skill, Hand-Drawn PPT Skill, SOIL Deck Skills, Presentation Forge, HTML PPT Skill, HTML to PPTX, AI Editable PPT Skill, Vela Slides, Bruce PPTX Generator, Tekion Slide Generator, PPT Skills, Paper to Scholar Slides, PPT Master, PPT Image to Editable, Research Group PPT Skill, SlideSage, Xidian Slides Skill, Paper to Slides Skill, Editable PPTX Skill, Pitch Deck Iterator, Zhongguose PPT Skill, ZJ Lab Academic PPTX Skills, Consulting Diagnosis PPT Skill, Token Slides, PowerPoint Skill, Slide Weaver, PPT Template Fill, Frontend Slides, Web PPT, Codex XKPPT Skill, PPT Design Skill, HFUT Presentation Studio, SJTU Beamer PPT, Special Achievement Report, HTML PPT Academic Skill, Economics Empirical PPT Skill, HTML Report Generator, Demo Prep Skill, Avatar PPT Master, HTML PPT Video Skill, AI PPT Skill, SVG to PPTX Skill, Doc to PPT Skill, Ultimate PPT Master Skill, Anthropic PPTX (official), Baoyu Skills, AI Skills (Cross-Platform).</sub>
